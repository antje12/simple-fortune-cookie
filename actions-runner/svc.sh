...
SVC_NAME="actions.runner.antje12-simple-fortune-cookie.devopsacademy-instance5.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (antje12-simple-fortune-cookie.devopsacademy-instance5)"
